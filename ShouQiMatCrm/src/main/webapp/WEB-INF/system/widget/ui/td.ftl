...
<#macro td id=""
	...
	>
<#if label!="">
<td<#if id?? && id!=""> id="${id}"</#if> width="${labelWidth}%" class="pn-flabel<#if noHeight=='false'> pn-flabel-h</#if>"><#if required!="false"><span class="pn-frequired">*</span></#if>${label}<#if hasColon="true">${colon}</#if></td><#rt/>
